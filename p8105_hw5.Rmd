...
The file consists of information for 52,179 homicide victims from 2010 to 2013. For each victim, the file contains information across 12 variables including their name, sex, the date the homicide was reported, the city, the state, region (latitude and longitude), and legal case status (disposition). 
